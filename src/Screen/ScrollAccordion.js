...
import { Animated, Dimensions, Easing, ImageBackground, Text, View, StyleSheet, TouchableOpacity, ScrollView } from 'react-native';
...
const categoryTouts = [ //the touts are the clickable image items that hold our links
  { image: require('../images/meal3.png'), title: 'Category1', links: categoryLinks },
  { image: require('../images/meal3.png'), title: 'Category2', links: categoryLinks },
  { image: require('../images/meal3.png'), title: 'Category3', links: categoryLinks },
]
